...
![Test](/assets/Car.png) Export file as a .png[^1] and either send it to the [Winter Contest Submission channel](https://discord.gg/TPeMbdHHfK) or create an issue on this GitHub with your file.
